            ...
            @component('components.card-form', ['title' => 'Registrar equipo', 'show' => false])
                <form action="{{ route('equipos.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation"
                    ...
                    <div class="form-row justify-content-center">
                        ...
                        <div class="form-group col-12 col-md-6">
                            ...
                            <input type="text" class="form-control @error('serie') is-invalid @enderror" name="serie"
                                id="serie" value="{{ old('serie') }}" maxlength="100" required>
                            @error('serie')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-row justify-content-center">
                        <div class="form-group col-12 col-md-6">
                            ...
                            <input type="text" class="form-control @error('servicio') is-invalid @enderror" name="servicio"
                                id="servicio" value="{{ old('servicio') }}" maxlength="200">
                            @error('servicio')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-row justify-content-center">
                        ...
                        <div class="form-group col-12 col-md-6">
                            ...
                            <input type="text" class="form-control @error('ubicacion') is-invalid @enderror" name="ubicacion"
                                id="ubicacion" value="{{ old('ubicacion') }}" maxlength="200" required>
                            @error('ubicacion')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-row justify-content-center">
                        ...
                        <div class="form-group col-12 col-md-4">
                            <label class="form-label" for="text">Frecuencia calibración <span
                                    class="text-danger">*</span></label>
                            <select class="form-control" name="frecuencia_calibracion" id="frecuencia_calibracion" disabled>
                                <option value="" selected disabled>Seleccione...</option>
                    ...
                    <div class="form-row justify-content-center">
                        <div class="form-group col-12 col-md-4">
                            ...
                            <input type="text" class="form-control @error('modelo') is-invalid @enderror" name="modelo"
                                id="modelo" value="{{ old('modelo') }}" maxlength="100">
                            @error('modelo')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-row justify-content-center">
                        <div class="form-group col-12 col-md-4">
                            ...
                            <input type="text" class="form-control @error('h_reg_INVIMA') is-invalid @enderror"
                                name="h_reg_INVIMA" id="h_reg_INVIMA" value="{{ old('h_reg_INVIMA') }}" maxlength="100"
                                required>
                            @error('h_reg_INVIMA')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="form-group col-12 col-md-4">
                            ...
                            <input type="text" class="form-control @error('h_reg_importacion') is-invalid @enderror"
                                name="h_reg_importacion" id="h_reg_importacion" value="{{ old('h_reg_importacion') }}"
                        ...
                        <div class="form-group col-12 col-md-4">
                            ...
                            <input type="text" class="form-control @error('h_reg_FDA') is-invalid @enderror"
                                name="h_reg_FDA" id="h_reg_FDA" value="{{ old('h_reg_FDA') }}" maxlength="100" required>
                            @error('h_reg_FDA')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-row justify-content-center">
                        <div class="form-group col-12 col-md-4">
                            ...
                            <input type="text" class="form-control @error('h_url_sitio_web') is-invalid @enderror"
                                name="h_url_sitio_web" id="h_url_sitio_web" value="{{ old('h_url_sitio_web') }}"
                        ...
                        <div class="form-group col-12 col-md-4">
                            ...
                            <input type="text" class="form-control @error('h_direccion_proveedor') is-invalid @enderror"
                                ...
                                value="{{ old('h_direccion_proveedor') }}" maxlength="100" required>
                        ...
                        <div class="form-group col-12 col-md-4">
                            ...
                            <input type="text" class="form-control @error('h_telefono') is-invalid @enderror"
                                name="h_telefono" id="h_telefono" value="{{ old('h_telefono') }}" maxlength="20" required>
                            @error('h_telefono')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-row justify-content-center">
                        <div class="form-group col-12 col-md-4">
                            ...
                            <input type="text" class="form-control @error('h_vida_util') is-invalid @enderror"
                                name="h_vida_util" id="h_vida_util" value="{{ old('h_vida_util') }}" maxlength="20"
                                required>
                            @error('h_vida_util')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="form-group col-12 col-md-4">
                            ...
                            <input type="text" class="form-control @error('h_costo') is-invalid @enderror" name="h_costo"
                                id="h_costo" value="{{ old('h_costo') }}" maxlength="50" required>
                            @error('h_costo')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group col-12 col-md-4">
                            ...
                            <input type="text" class="form-control @error('h_garantia') is-invalid @enderror"
                                name="h_garantia" id="h_garantia" value="{{ old('h_garantia') }}" maxlength="50" required>
                            @error('h_garantia')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-row justify-content-center">
                        <div class="form-group col-12 col-md-10">
                            ...
                            <input type="text" class="form-control @error('rf_url_doc_adquisicion') is-invalid @enderror"
                                ...
                                value="{{ old('rf_url_doc_adquisicion') }}" required>
                    ...
                    <div class="form-row justify-content-center">
                        <div class="form-group col-12 col-md-5">
                            ...
                            <input type="date" class="form-control @error('rf_fecha_instalacion') is-invalid @enderror"
                                ...
                                value="{{ old('rf_fecha_instalacion') }}" required>
                        ...
                        <div class="form-group col-12 col-md-5">
                            ...
                            <input type="date" class="form-control @error('rf_fecha_operacion') is-invalid @enderror"
                                name="rf_fecha_operacion" id="rf_fecha_operacion" value="{{ old('rf_fecha_operacion') }}"
                                required>
                    ...
                    <div class="row mt-4 justify-content-between mx-2">
                        <a href="{{ route('equipos.index') }}" class="btn btn-default col-12 col-md-5 mt-2 " type="button">
